  ...
  return (
    <View style={styles.container}>
      <View style={styles.whiteBox}>
        ...
        <TextInput placeholder="Bus Number" placeholderTextColor="#A0A0A0" style={styles.input} />

        <Text style={styles.label}>Bus Registration ID</Text>
        <TextInput placeholder="Bus Registration ID" placeholderTextColor="#A0A0A0" style={styles.input} />

        <TouchableOpacity style={styles.button} onPress={() => router.push("/driver/profile-update")}>
